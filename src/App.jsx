...
function Page3({sh,forms,totalPages,pageNum=3,interactive,coins,setCoins}){
  const displayCoins=coins||sh.coins||{};
...
export default function App(){
  ...
  },[currentHp,tempHp,deathSaves,resourceUses,usedSlots,racialUses,heroicInspiration,spPrep,coins]);
